...
/* impl SegmentBuilder {
    ...
    pub fn fem_calibration(self, fem: &mut FEM) -> Self {
        // Hardpoints stiffness
        log::info!("HARDPOINTS STIFFNESS");
        fem.switch_inputs(gmt_fem::Switch::Off, None).switch_outputs(gmt_fem::Switch::Off, None);
        let Some(gain) =
        ...
        for i in 0..7 {
            ...
            fem.switch_inputs(gmt_fem::Switch::On, None).switch_outputs(gmt_fem::Switch::On, None);
