...
impl Write<M2SegmentPiston> for M2Lom {
    fn write(&mut self) -> Option<Data<M2SegmentPiston>> {
        <LinearOpticalModel as Write<M2SegmentPiston>>::write(&mut self.0)
    }
}
