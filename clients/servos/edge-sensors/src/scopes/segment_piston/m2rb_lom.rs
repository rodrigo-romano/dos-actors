...
impl Write<M2RBSegmentPiston> for M2RBLom {
    fn write(&mut self) -> Option<Data<M2RBSegmentPiston>> {
        <LinearOpticalModel as Write<M2RBSegmentPiston>>::write(&mut self.0)
    }
}
