...
impl Write<M1SegmentWfeRms> for M1Lom {
    fn write(&mut self) -> Option<Data<M1SegmentWfeRms>> {
        <LinearOpticalModel as Write<M1SegmentWfeRms>>::write(&mut self.0)
    }
}
