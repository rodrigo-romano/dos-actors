...
async fn main() -> anyhow::Result<()> {
    ...
    */
    ...
    let mut m2_tt_cmd: Initiator<_, FSM_RATE> = Signals::new(vec![14], n_step).into();
    //let mut m2_tt_cmd: Initiator<_> = tt_signals.into();
    // FEM
    ...
    println!(
        "{source}{m1_hardpoints}{m1_hp_loadcells}{m2_positionner}{m2_piezostack}{m2_tiptilt}{fem}{gmt_on_axis}{wfe_rms_logs}"
    );
